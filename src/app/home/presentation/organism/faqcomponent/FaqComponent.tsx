		...
		<section className="faq-section-components">
			...
			<section className="faq-grid">
				<section className="section-paragraph">
					...
					<p>
						Es muy ágil y rápido, se resuelve en unos simples pasos: -Registrate
						o inicia sesión. -Realiza el proceso de validación de identidad y
						acepta terminos y condiciones. -Ingresa al market y selecciona la
						Startup en la que deseas invertir, selecciona el monto y realiza tu
						compra. -Completa el pago y firma la compra. -Recibe tu certificado
						de inversión.
					</p>
				...
				<section className="section-map">
					{Faq.map((item) => (
						<Accordeon key={item.title} title={item.title} body={item.body} />
					))}
				</section>
			</section>
		</div>
